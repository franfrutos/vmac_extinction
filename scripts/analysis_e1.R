...
preds <- get_predictions(d_RT, d_RTe, fit_r1_power, fit_e1_power)
...
comps <- get_comparisons(d_RT, d_RTe, fit_r1_power, fit_e1_power)
...
figure1 <- grid.arrange(predictions, comparisons, nrow = 2)
